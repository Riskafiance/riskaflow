...
const ReportsTab = ({ invoices }) => {
  ...
  const CardWrapper = ({ children, style }) => (
    <div 
      style={{ backgroundColor: '#ffffff', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -1px rgba(0,0,0,0.06)', border: '1px solid #f3f4f6', transition: 'transform 0.2s, box-shadow 0.2s', padding: '30px', ...style }}
  ...
  return (
    <div style={{ backgroundColor: 'transparent', position: 'relative', animation: 'fadeIn 0.3s ease-in-out' }}>
      ...
      <div style={{ marginBottom: '30px' }}>
        <h2 style={{ margin: 0, color: '#111827', fontSize: '28px', fontWeight: '800', letterSpacing: '-0.02em' }}>Financial Reports</h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px', marginBottom: '40px' }}>
        ...
        <CardWrapper>
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '20px' }}>
            <div style={{ width: '56px', height: '56px', borderRadius: '12px', background: 'linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '28px' }}>💰</div>
          ...
          <div style={{ fontSize: '42px', fontWeight: '900', color: '#111827', letterSpacing: '-0.02em' }}>
        ...
        <CardWrapper>
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '20px' }}>
            <div style={{ width: '56px', height: '56px', borderRadius: '12px', background: 'linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '28px' }}>⏳</div>
